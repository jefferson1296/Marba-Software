...
{
    public partial class formRepEtiquetaPrecoNomeCodigo : Form
    {
        public formRepEtiquetaPrecoNomeCodigo()
        {
            InitializeComponent();
        }

        private void formRepEtiquetaPrecoNomeCodigo_Load(object sender, EventArgs e)
        {
