...
{
    public partial class formRepPrecoRedondoPromocao : Form
    {
        public formRepPrecoRedondoPromocao()
        {
            InitializeComponent();
        }

        private void formRepPrecoRedondoPromocao_Load(object sender, EventArgs e)
        {
