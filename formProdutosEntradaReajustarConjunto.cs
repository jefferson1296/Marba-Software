...
{
    public partial class formProdutosEntradaReajustarConjunto : Form
    {
        ...
        public formProdutosEntradaReajustarConjunto()
        {
            InitializeComponent();
        }
        public formProdutosEntradaReajustarConjunto(formProdutosEntradaDarEntrada Entrada, int ID_Produto)
        {
            InitializeComponent();
            entrada = Entrada;
            id_produto = ID_Produto;
        }
        public formProdutosEntradaReajustarConjunto(formProdutosEntradaAnaliseAvancada Analise, int ID_Produto)
        {
            InitializeComponent();
        ...
        private void formProdutosEntradaReajustarConjunto_Load(object sender, EventArgs e)
        {
            if (analise_avancada)
            {
                string conjunto = analise.Produtos_Entrada.Where(x => x.ID_Produto == id_produto).Select(x => x.Nome_Conjunto).FirstOrDefault();
                conjuntoTextBox.Text = conjunto;
                ...
                decimal quantidade_produtos = analise.Produtos_Fornecedor.Where(x => x.ID_Produto == id_produto).Select(x => x.Qtd_Produtos).FirstOrDefault();
                quantidadeTextBox.Text = quantidade_produtos.ToString();
            }
            else
            {
                string conjunto = entrada.Produtos_Entrada.Where(x => x.ID_Produto == id_produto).Select(x => x.Nome_Conjunto).FirstOrDefault();
                conjuntoTextBox.Text = conjunto;
                ...
                decimal quantidade_produtos = entrada.Produtos_Fornecedor.Where(x => x.ID_Produto == id_produto).Select(x => x.Qtd_Produtos).FirstOrDefault();
                quantidadeTextBox.Text = quantidade_produtos.ToString();
            }
        ...
        private void CalcularInformacoesFinanceiras()
        {
            ...
            if (analise_avancada)
            {
                ...
                quantidade_produtos = analise.Produtos_Fornecedor.Where(x => x.ID_Produto == id_produto).Select(x => x.Qtd_Produtos).FirstOrDefault();
            }
            else
            {
                ...
                quantidade_produtos = entrada.Produtos_Fornecedor.Where(x => x.ID_Produto == id_produto).Select(x => x.Qtd_Produtos).FirstOrDefault();
            }
            ...
            custo_total = base_novo + ipi_novo + icms_novo;
            custo_antigo = base_antigo + ipi_antigo + icms_antigo / quantidade_produtos;
            custo_novo = custo_total / quantidade_produtos;
            ...
            custoTotalTextBox.Text = custo_total.ToString("C");
        }
        ...
        private void buttonReajustar_Click(object sender, EventArgs e)
        {
            if (analise_avancada)
            {
                ...
                foreach (Produto_Lote Variacao in analise.Lote)
                {
                    ...
                    {
                        int quantidade_produtos = analise.Produtos_Entrada.Where(x => x.ID_Produto == id_produto).Select(x => x.Qtd_Produtos).FirstOrDefault();
            ...
            else
            {
                ...
                foreach (Produto_Lote Variacao in entrada.Lote)
                {
                    if (Variacao.ID_Produto == id_produto)
                    {
                        int quantidade_produtos = entrada.Produtos_Entrada.Where(x => x.ID_Produto == id_produto).Select(x => x.Qtd_Produtos).FirstOrDefault();
                        base_novo = base_novo / quantidade_produtos;
